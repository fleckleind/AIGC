...
from patchGAN import Discriminator
...
class TrainVQGAN:
    def __init__(self, args):
        self.vqgan = VQGAN(args).to(device=args.device)  # model
        ...
        for epoch in range(args.epochs):
            with tqdm(range(len(train_dataset))) as pbar:
                for i, imgs in zip(pbar, train_dataset):
                    ...
                    # coefficient discriminator factor as 0 before threshold
                    ...
                    if i % 10 == 0:
                        # save synthetic images every 10 epoch
                        with torch.no_grad():
...
if __name__ == '__main__':
    ...
    args.dataset_path = '/kaggle/input/celebahq-resized-256x256/celeba_hq_256'
